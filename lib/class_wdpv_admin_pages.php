...
class Wdpv_AdminPages {
	...
	function register_settings () {
		...
		add_settings_section('wdpv_voting', __('Abstimmungseinstellungen', 'wdpv'), (''), 'wdpv_options_page');
		...
		if (defined('BP_VERSION')) {
			...
			add_settings_section('wdpv_bp', __('BuddyPress Integration', 'wdpv'), (''), 'wdpv_options_page');
		...
		if (!is_multisite() || (is_multisite() && is_network_admin())) { // On multisite, plugins are available only on network admin pages
			...
			add_settings_section('wdpv_plugins', __('Voting Erweiterungen', 'wdpv'), (''), 'wdpv_options_page');
	...
	function create_blog_admin_menu_entry () {
		...
		add_options_page(__('PS Voting', 'wdpv' ), __('PS Voting', 'wdpv' ), $settings_perms, 'wdpv', array($this, 'create_admin_page'));
		add_dashboard_page(__( 'Abstimmungsstatistik', 'wdpv' ), __( 'Abstimmungsstatistik', 'wdpv' ), 'manage_options', 'wdpv_stats', array($this, 'create_stats_page'));
	}
